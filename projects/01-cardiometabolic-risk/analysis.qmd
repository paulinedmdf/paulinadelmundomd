...
- **Leakage is the first bug to rule out.** Feeding the ATP III components back as predictors produces AUC ≈ 1.0 — not because the model is brilliant, but because the outcome is definitionally derived from those inputs. Demographics + BMI alone land at a realistic, defensible discrimination.
